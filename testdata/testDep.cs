...
class MyStack : Stack
{
    public MyStack()
    {
        var defaultArgocd_serverDeployment = new Kubernetes.Apps.V1.Deployment("defaultArgocd_serverDeployment", new Kubernetes.Types.Inputs.Apps.V1.DeploymentArgs
        {
            ApiVersion = "apps/v1",
            Kind = "Deployment",
